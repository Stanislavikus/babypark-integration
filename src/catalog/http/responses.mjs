...
const conflictPrefixes = ['INGEST_REPLAY_CONFLICT','INGEST_REPLAY_DIGEST_CONFLICT','INGEST_REPLAY_DIGEST_MISMATCH','INGEST_REPLAY_DIGEST_INCOMPLETE','INGEST_REPLAY_SEQUENCE_GAP','INGEST_REPLAY_HEADER_HASH_MISMATCH','FULL_APPLY_CHUNK_CONFLICT','FULL_APPLY_GENERATION_MIXED'];
